...
(() => {
  ...
  const resultExportCanvas = document.createElement("canvas");
  const resultExportCtx = resultExportCanvas.getContext("2d", { alpha: false });
  ...
  const guideDoneButton = document.getElementById("guideDoneButton");
  ...
  const copyrightModalBackdrop = document.getElementById("copyrightModalBackdrop");
  const copyrightModalClose = document.getElementById("copyrightModalClose");
  const copyrightDoneButton = document.getElementById("copyrightDoneButton");
  ...
  const translations = {
    zh: {
      ...
      userGuideShort: "指南｜Guide",
      lineBrowserNotice: "您目前可能使用 LINE 內建瀏覽器；若無法正常繪圖或儲存，請點右上角選單，改用 Safari 或 Chrome 開啟。",
      guideKicker: "快速開始",
      guideTitle: "使用指南｜User Guide",
      guideIntro: "不用會畫畫，也沒有標準答案；跟著直覺完成幾筆線條即可。",
      guideStep1Title: "選擇直覺色彩",
      guideStep1Text: "點選此刻最有感覺的顏色。",
      guideStep2Title: "選擇創作模式",
      guideStep2Text: "5 秒模式為 5 秒主創作＋5 秒完成；10 秒模式為 10 秒主創作＋10 秒完成。",
      guideStep3Title: "觸碰畫布開始",
      guideStep3Text: "按開始後，第一筆落在畫布時才正式倒數；用手指或滑鼠自由畫畫。",
      guideStep4Title: "完成與分析",
      guideStep4Text: "倒數結束後自動分析；也可隨時按「提早完成」或「重新開始」。",
      guideStep5Title: "儲存兩種作品",
      guideStep5Text: "可儲存原始手繪圖，或包含圖像、文字、指標與時間的 AI 心境成果卡。",
      appleGuide: "iPhone／iPad 建議使用 Safari。儲存時請長按作品圖片，再選擇「儲存到照片」。",
      androidGuide: "Android 建議使用 Google Chrome。儲存時可長按圖片或下載 PNG。",
      lineGuide: "若 LINE 內建瀏覽器無法正常繪圖或儲存，請點右上角選單，改用 Safari 或 Chrome 開啟。",
      guidePrivacy: "所有繪圖與分析只在瀏覽器本機進行，不會自動上傳或保存。",
      guideDone: "開始體驗",
      copyrightBrand: "© 2026 Hylove Business Inc / AI-Mind Care",
      copyrightTerms: "完整著作權與使用條款",
      copyrightKicker: "智慧財產權保護",
      copyrightModalTitle: "完整著作權與使用條款",
      copyrightEffectiveDate: "生效版本：V2.6.1｜© 2026 Hylove Business Inc / AI-Mind Care",
      copyrightSection1Title: "一、著作權與智慧財產權",
      copyrightSection1Text: "本網站之程式碼、互動流程、介面設計、文字內容、視覺呈現、分析邏輯、成果卡版型，以及 AI-Mind Care 與腦心畫相關名稱與識別，均由 Hylove Business Inc. 擁有、依法使用或受相關智慧財產權保護。",
      copyrightSection2Title: "二、允許的使用方式",
      copyrightSection2Text: "使用者可為個人、教育及非商業用途操作本網站，並可儲存、展示或分享自己完成的原始手繪圖與 AI 心境成果卡。公開分享時，請保留成果卡上既有之品牌與著作權標示。",
      copyrightSection3Title: "三、使用者創作與隱私",
      copyrightSection3Text: "使用者保有其自行繪製之原始手繪內容。本網站不會自動上傳或保存作品；繪圖、分析與成果產生均在使用者瀏覽器本機進行。AI 心境成果僅供創意表達與自我覺察。",
      copyrightSection4Title: "四、禁止事項",
      copyrightSection4Text: "未經 Hylove Business Inc. 事前書面同意，不得複製或重製網站程式碼與整體設計、修改後另行發布、移除著作權標示、反向工程、出售、出租、轉授權、建立具實質相同功能之商業服務，或誤導他人認為本網站及其內容由其他個人或機構所有。",
      copyrightSection5Title: "五、使用限制與免責聲明",
      copyrightSection5Text: "本服務依現況提供，不同裝置與瀏覽器的操作或儲存方式可能不同。分析結果不是心理、醫療或健康評估、診斷或治療建議，亦不得用於人事、教育、保險或其他自動化決策。",
      copyrightSection6Title: "六、商業使用與授權",
      copyrightSection6Text: "任何商業展示、系統整合、複製部署、品牌合作、授權或衍生產品開發，均須事先取得 Hylove Business Inc. 的書面許可。",
      copyrightContact: "商業授權、合作或書面許可，請透過 Hylove Business Inc. 官方網站聯繫。",
      copyrightDone: "我已了解",
      eyebrow: "5／10 秒心境靈感藝術",
      subtitle: "腦心畫",
      intro: "5 秒主創作＋5 秒完成作品，或 10 秒主創作＋10 秒完成作品；時間結束後自動分析。",
      controlKicker: "創作設定",
      ...
      curve: "曲線流動",
      energy: "畫面能量",
      saveAIMoodResultCard: "儲存 AI 心境成果卡",
      saveOriginalDrawing: "儲存原始手繪圖",
      drawAgain: "再畫一次",
      saveGuide: "AI 心境成果卡包含圖像、藝術靈感、四項指標與提醒文字；手機可長按圖片儲存到照片，電腦則下載 PNG。",
      disclaimer: "此作品依線條特徵生成，僅供創意表達與自我覺察，不是心理、醫療或健康評估或診斷。",
      howTitle: "腦心畫如何運作？",
      step1Title: "選擇 5 秒或 10 秒",
      step1Text: "先選擇主創作時間：5 秒快速模式，或 10 秒細緻模式。",
      step2Title: "同樣秒數完成作品",
      step2Text: "5 秒模式再提供 5 秒；10 秒模式再提供 10 秒。您也可隨時按「提早完成」。",
      ...
      resultReady: "作品已完成。您可儲存原始手繪圖或包含文字的 AI 心境成果卡。",
      savePreviewTitle: "儲存到手機照片",
      savePreviewInstruction: "請長按下方圖片，再選擇「儲存到照片」或「下載圖片」。不同手機的選項名稱可能略有不同。",
      downloadFile: "下載 PNG 檔案",
      done: "完成",
      downloadArtDone: "AI 心境成果卡已準備好；手機可長按圖片儲存，電腦可在 Downloads 查看。",
      downloadDrawingDone: "原始手繪圖已準備好；手機可長按圖片儲存，電腦可在 Downloads 查看。",
      downloadFailed: "無法準備圖片，請改用截圖儲存。",
      exportBrand: "AI-Mind Care: Figure Drawing 腦心畫",
      exportTitle: "今日心境靈感藝術",
      exportInspiration: "藝術靈感",
      exportReminder: "此作品依線條特徵生成，僅供創意表達與自我覺察，不是心理、醫療或健康評估或診斷。",
    ...
    en: {
      ...
      userGuideShort: "Guide",
      lineBrowserNotice: "You may be using LINE’s in-app browser. If drawing or saving does not work correctly, open the top-right menu and continue in Safari or Chrome.",
      guideKicker: "QUICK START",
      guideTitle: "User Guide",
      guideIntro: "No drawing skills are needed, and there is no right or wrong result. Simply follow your intuition and draw a few lines.",
      guideStep1Title: "Choose an intuitive color",
      guideStep1Text: "Tap the color that feels right at this moment.",
      guideStep2Title: "Choose a drawing mode",
      guideStep2Text: "The 5-second mode gives 5 seconds to draw plus 5 seconds to finish. The 10-second mode gives 10 seconds plus 10 seconds to finish.",
      guideStep3Title: "Touch the canvas to begin",
      guideStep3Text: "After choosing Start, the countdown begins only when your first line touches the canvas. Draw freely with a finger or mouse.",
      guideStep4Title: "Finish and analyze",
      guideStep4Text: "The system analyzes automatically when time ends. You may also tap Finish Now or Start Over at any time.",
      guideStep5Title: "Save two kinds of artwork",
      guideStep5Text: "Save the original drawing or an AI mood result card containing the image, text, indicators, and completion time.",
      appleGuide: "For iPhone or iPad, Safari is recommended. To save, long-press the artwork image and choose Save to Photos.",
      androidGuide: "For Android, Google Chrome is recommended. Long-press the image or download the PNG file.",
      lineGuide: "If LINE’s in-app browser cannot draw or save correctly, open the top-right menu and continue in Safari or Chrome.",
      guidePrivacy: "All drawing and analysis stay locally in the browser and are not automatically uploaded or stored.",
      guideDone: "Start Experience",
      copyrightBrand: "© 2026 Hylove Business Inc / AI-Mind Care",
      copyrightTerms: "Full Copyright & Terms of Use",
      copyrightKicker: "IP PROTECTION",
      copyrightModalTitle: "Full Copyright & Terms of Use",
      copyrightEffectiveDate: "Effective version: V2.6.1 | © 2026 Hylove Business Inc / AI-Mind Care",
      copyrightSection1Title: "1. Copyright and Intellectual Property",
      copyrightSection1Text: "The website code, interaction flow, interface design, written content, visual presentation, analysis logic, result-card layout, and the names and identifiers associated with AI-Mind Care and Figure Drawing are owned, lawfully used, or protected by Hylove Business Inc. under applicable intellectual-property laws.",
      copyrightSection2Title: "2. Permitted Use",
      copyrightSection2Text: "Users may operate this website for personal, educational, and non-commercial purposes and may save, display, or share their own original drawings and AI Mood Result Cards. Existing brand and copyright notices should be retained when a result card is shared publicly.",
      copyrightSection3Title: "3. User Creations and Privacy",
      copyrightSection3Text: "Users retain their interests in the original content they draw. The website does not automatically upload or store artwork; drawing, analysis, and result generation take place locally in the user’s browser. AI mood results are intended only for creative expression and self-reflection.",
      copyrightSection4Title: "4. Prohibited Uses",
      copyrightSection4Text: "Without prior written permission from Hylove Business Inc., users may not copy or reproduce the website code or overall design, publish modified versions, remove copyright notices, reverse engineer, sell, rent, sublicense, create a commercially equivalent service, or falsely represent that the website or its content belongs to another person or organization.",
      copyrightSection5Title: "5. Limitations and Disclaimer",
      copyrightSection5Text: "The service is provided as available, and operation or saving methods may vary by device and browser. Results are not psychological, medical, or health assessments, diagnoses, or treatment advice and must not be used for employment, education, insurance, or other automated decision-making.",
      copyrightSection6Title: "6. Commercial Use and Licensing",
      copyrightSection6Text: "Commercial demonstrations, system integration, replicated deployment, brand collaboration, licensing, or derivative-product development require prior written permission from Hylove Business Inc.",
      copyrightContact: "For commercial licensing, collaboration, or written permission, please contact Hylove Business Inc. through its official website.",
      copyrightDone: "I Understand",
      eyebrow: "5 / 10-SECOND MOOD-INSPIRED ART",
      subtitle: "Mind Art",
      intro: "Choose 5 seconds plus 5 seconds to finish, or 10 seconds plus 10 seconds to finish. The system analyzes automatically when time is up.",
      ...
      saveAIMoodResultCard: "Save AI Mood Result Card",
      saveOriginalDrawing: "Save Original Drawing",
      drawAgain: "Draw Again",
      saveGuide: "The AI mood result card includes the artwork, inspiration text, four indicators, and the reminder. On mobile, long-press the image to save it; on a computer, download the PNG.",
      ...
      step2Title: "Get the same time again to finish",
      step2Text: "The 5-second mode adds 5 finishing seconds; the 10-second mode adds 10. You can also tap Finish Now at any time.",
      ...
      resultReady: "Your artwork is ready. You may save the original drawing or an AI mood result card with text.",
      ...
      downloadArtDone: "The AI mood result card is ready. On mobile, long-press the image to save it; on a computer, check Downloads.",
      ...
      exportBrand: "AI-Mind Care: Figure Drawing — Mind Art",
      exportTitle: "Today’s Mood-Inspired Art",
      exportInspiration: "Art Inspiration",
      exportReminder: "Generated from line features for creative expression and self-reflection only. This is not a psychological, medical, or health assessment or diagnosis.",
  ...
  function tickCountdown(now = performance.now()) {
    ...
    const finishingDuration = mainDuration;
    const totalDuration = mainDuration + finishingDuration;
    ...
    if (elapsed < totalDuration) {
      ...
      statusMessage.textContent = t("extraStatus", { seconds: finishingDuration });
      countdownFrame = requestAnimationFrame(tickCountdown);
      return;
    }
  ...
  function buildResultCardCanvas() {
    const ctx = resultExportCtx;
    const width = 1920;
    const height = 1080;
    resultExportCanvas.width = width;
    resultExportCanvas.height = height;

    const background = ctx.createLinearGradient(0, 0, width, height);
    background.addColorStop(0, "#fbf9ff");
    background.addColorStop(0.55, "#f7f4ff");
    background.addColorStop(1, "#f2f8ff");
    ctx.fillStyle = background;
    ctx.fillRect(0, 0, width, height);

    ctx.textBaseline = "top";
    ctx.fillStyle = "#7257d7";
    ctx.font = '800 27px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    ctx.fillText(t("exportBrand"), 70, 38);

    ctx.fillStyle = "#2e2938";
    ctx.font = '900 54px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    ctx.fillText(t("exportTitle"), 70, 78);

    const artX = 70;
    const artY = 165;
    const artSize = 825;
    fillRoundedRect(ctx, artX, artY, artSize, artSize, 42, "rgba(255,255,255,.92)", "rgba(114,87,215,.10)");
    ctx.save();
    roundedRectPath(ctx, artX, artY, artSize, artSize, 42);
    ctx.clip();
    ...
    const rightX = 970;
    const rightW = 880;
    const moodGradient = ctx.createLinearGradient(rightX, 160, rightX + rightW, 360);
    moodGradient.addColorStop(0, "rgba(239,233,255,.96)");
    moodGradient.addColorStop(1, "rgba(233,246,255,.96)");
    fillRoundedRect(ctx, rightX, 165, rightW, 250, 36, moodGradient);

    ctx.fillStyle = "#777084";
    ctx.font = '800 27px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    ctx.fillText(t("exportInspiration"), rightX + 42, 205);

    ctx.fillStyle = "#5f46c8";
    ctx.font = '900 48px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    ctx.fillText(moodName.textContent || "—", rightX + 42, 250);

    ctx.fillStyle = "#5d5766";
    ctx.font = '500 29px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    wrapCanvasText(ctx, moodMessage.textContent || "", rightX + 42, 325, rightW - 84, 42, 2);

    const metricLabels = [t("speed"), t("pressure"), t("curve"), t("energy")];
    const metricValues = [speedMetric.textContent, pressureMetric.textContent, curveMetric.textContent, energyMetric.textContent];
    const gap = 22;
    const metricW = (rightW - gap) / 2;
    const metricH = 150;
    metricLabels.forEach((label, index) => {
      const col = index % 2;
      const row = Math.floor(index / 2);
      const x = rightX + col * (metricW + gap);
      const y = 455 + row * (metricH + gap);
      fillRoundedRect(ctx, x, y, metricW, metricH, 28, "rgba(255,255,255,.78)", "rgba(88,72,112,.15)");
      ctx.textAlign = "center";
      ctx.fillStyle = "#7c7584";
      ctx.font = '500 25px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
      ctx.fillText(label, x + metricW / 2, y + 28);
      ctx.fillStyle = "#3f394b";
      ctx.font = '900 35px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
      ctx.fillText(metricValues[index] || "—", x + metricW / 2, y + 76);
      ctx.textAlign = "left";
    });

    fillRoundedRect(ctx, rightX, 815, rightW, 175, 28, "rgba(255,255,255,.60)", "rgba(88,72,112,.10)");
    ctx.fillStyle = "#77707d";
    ctx.font = '500 23px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    wrapCanvasText(ctx, t("exportReminder"), rightX + 34, 850, rightW - 68, 34, 4);

    const artworkTimestamp = completedAt || new Date();
    ctx.fillStyle = "rgba(82,73,98,.64)";
    ctx.font = '600 20px "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif';
    ctx.textAlign = "left";
    ctx.fillText("© Hylove Business Inc.", rightX + 34, 958);
    ctx.textAlign = "right";
    ctx.fillText(formatCardTimestamp(artworkTimestamp), rightX + rightW - 34, 958);
    ctx.textAlign = "left";

    return resultExportCanvas;
  }
  ...
  function syncModalBodyState() {
    const anyModalOpen = !saveModal.classList.contains("hidden") || !guideModal.classList.contains("hidden") || !copyrightModal.classList.contains("hidden");
  ...
  function openGuide() {
    ...
    syncModalBodyState();
    window.setTimeout(() => guideModalClose.focus(), 0);
  }
  ...
  function openCopyright() {
    ...
    syncModalBodyState();
    window.setTimeout(() => copyrightModalClose.focus(), 0);
  }

  function closeCopyright() {
    copyrightModal.classList.add("hidden");
    syncModalBodyState();
    copyrightButton.focus();
  }
  ...
  drawAgainButton.addEventListener("click", restartFromResult);
  downloadArtButton.addEventListener("click", () => {
    const timestamp = completedAt || new Date();
    downloadCanvas(buildResultCardCanvas(), `AI-Mind-Mood-Result-Card-${formatFilenameTimestamp(timestamp)}.png`, "downloadArtDone");
  });
  downloadDrawingFromResultButton.addEventListener("click", () => {
    const timestamp = completedAt || new Date();
    downloadCanvas(drawingCanvas, `AI-Mind-Original-Drawing-${formatFilenameTimestamp(timestamp)}.png`, "downloadDrawingDone");
  });

  guideButton.addEventListener("click", openGuide);
  guideModalClose.addEventListener("click", closeGuide);
  guideDoneButton.addEventListener("click", closeGuide);
  guideModalBackdrop.addEventListener("click", closeGuide);

  copyrightButton.addEventListener("click", openCopyright);
  copyrightModalClose.addEventListener("click", closeCopyright);
  copyrightDoneButton.addEventListener("click", closeCopyright);
  copyrightModalBackdrop.addEventListener("click", closeCopyright);
  ...
  downloadPreviewButton.addEventListener("click", async () => {
    ...
    const link = document.createElement("a");
    link.href = src;
    link.download = savePreviewImage.dataset.filename || `AI-Mind-Artwork-${formatFilenameTimestamp(new Date())}.png`;
    document.body.appendChild(link);
    link.click();
    link.remove();
  });
  document.addEventListener("keydown", (event) => {
    ...
    if (!saveModal.classList.contains("hidden")) closeSavePreview();
    else if (!copyrightModal.classList.contains("hidden")) closeCopyright();
  ...
  const isLineBrowser = /(?:Line\/|LIFF)/i.test(navigator.userAgent || "");
  compatibilityNotice.classList.toggle("hidden", !isLineBrowser);
