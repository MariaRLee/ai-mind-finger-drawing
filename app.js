...
(() => {
  ...
  const shareArtButton = document.getElementById("shareArtButton");
  ...
  const translations = {
    zh: {
      ...
      subtitle: "腦心畫",
      intro: "不用畫畫技巧。選擇 5 或 10 秒，系統會先記錄分析時段的線條特徵；時間到後，您仍可繼續創作，並可儲存原始手繪圖與心境靈感藝術。",
      controlKicker: "創作設定",
      ...
      startOver: "重新開始",
      afterTimerTitle: "分析時段已完成，您可以繼續創作。",
      keepDrawing: "繼續畫畫",
      finishArtwork: "完成作品",
      downloadDrawing: "下載原始畫作",
      afterTimerNote: "系統會用前面的 5／10 秒作為分析依據；之後繼續畫的內容可保留在原始畫作中。",
      ready: "準備好了嗎？",
      ...
      downloadArt: "下載作品",
      shareArt: "分享作品",
      saveGuide: "若分享鍵沒有反應，請先按「下載作品」，再從手機相簿或檔案中分享。LINE、Facebook 等 App 內建瀏覽器建議改用 Safari 或 Chrome 開啟。",
      disclaimer: "此作品依線條特徵生成，僅供創意表達與自我覺察，不是心理、醫療或健康評估或診斷。",
      howTitle: "腦心畫如何運作？",
      step1Title: "選擇 5 或 10 秒",
      step1Text: "5 秒適合快速體驗；10 秒可留下更多線條與細節。",
      step2Title: "先分析，再創作",
      step2Text: "前面的 5／10 秒用來分析線條特徵；之後可自由繼續畫畫。",
      step3Title: "可儲存兩種作品",
      step3Text: "您可以儲存原始手繪圖，也可以儲存系統生成的心境靈感藝術。",
      ...
      continueStatus: "分析時段已完成，您可以繼續畫畫，也可以按「完成作品」。",
      keepDrawingStatus: "您可以繼續自由創作；原始畫作可另行儲存。",
      tooShort: "線條太少了，請再試一次並在畫布上多畫幾筆。",
      generating: "完成！正在生成你的今日心境靈感藝術。",
      resultReady: "作品已完成。您可儲存藝術作品，也可儲存原始手繪圖。",
      downloadArtDone: "作品已送至下載。手機請查看「檔案／下載項目」；電腦請查看 Downloads 資料夾。",
      shareArtDone: "分享選單已開啟，請選擇要分享的 App 或儲存位置。",
      downloadDrawingDone: "原始畫作已送至下載。手機請查看「檔案／下載項目」；電腦請查看 Downloads 資料夾。",
      shareCancelled: "已取消分享。您仍可按「下載作品」，再從相簿或檔案中分享。",
      downloadFailed: "無法自動下載。請截圖，或長按作品影像儲存。",
      shareUnsupported: "此瀏覽器暫不支援直接分享圖片。請先按「下載作品」，再從手機相簿或檔案中分享；也可以使用截圖。",
      shareFailed: "分享功能未能開啟。請改用 Safari 或 Chrome，或先下載作品再分享。",
    ...
    en: {
      ...
      subtitle: "Mind Art",
      intro: "No drawing skill is needed. Choose 5 or 10 seconds. The system records line features during the analysis period; when the timer ends, you may keep drawing and save both the raw drawing and the mood-inspired artwork.",
      ...
      afterTimerTitle: "The analysis period is complete. You may keep creating.",
      keepDrawing: "Keep Drawing",
      finishArtwork: "Finish Artwork",
      downloadDrawing: "Download Raw Drawing",
      afterTimerNote: "The first 5 / 10 seconds are used for analysis. Anything you draw afterward can still be preserved in the raw drawing.",
      ready: "Ready?",
      ...
      downloadArt: "Download Artwork",
      shareArt: "Share Artwork",
      saveGuide: "If Share does not respond, tap Download Artwork first, then share it from Photos or Files. When opened inside LINE, Facebook, or another in-app browser, use Safari or Chrome instead.",
      ...
      step2Text: "The first 5 / 10 seconds are used for line-feature analysis; after that, you may keep drawing freely.",
      step3Title: "Save two kinds of work",
      step3Text: "You can save the raw drawing and also save the generated mood-inspired artwork.",
      ...
      continueStatus: "The analysis period is complete. You may keep drawing or tap “Finish Artwork.”",
      keepDrawingStatus: "You can continue creating freely; the raw drawing can be saved separately.",
      ...
      downloadArtDone: "The artwork was sent to Downloads. On mobile, check Files / Downloads; on a computer, check the Downloads folder.",
      shareArtDone: "The share menu is open. Choose an app or save location.",
      downloadDrawingDone: "The raw drawing was sent to Downloads. On mobile, check Files / Downloads; on a computer, check the Downloads folder.",
      shareCancelled: "Sharing was cancelled. You can still download the artwork and share it from Photos or Files.",
      downloadFailed: "Unable to download automatically. Please take a screenshot or long-press the artwork to save it.",
      shareUnsupported: "This browser cannot directly share image files. Download the artwork first, then share it from Photos or Files; a screenshot also works.",
      shareFailed: "The share menu could not open. Try Safari or Chrome, or download the artwork first and share it afterward.",
  ...
  async function downloadCanvas(canvas, filename, doneKey) {
    try {
  ...
  async function shareCanvas(canvas, filename) {
    if (!window.isSecureContext || typeof navigator.share !== "function") {
      showSaveMessage("shareUnsupported");
      return;
    }
    ...
    try {
      ...
      await navigator.share({
        files: [file],
        title: currentLanguage === "zh" ? "AI-Mind Care 腦心畫" : "AI-Mind Care Figure Drawing",
        text: currentLanguage === "zh" ? "我的今日心境靈感藝術" : "My mood-inspired artwork today"
      });
      showSaveMessage("shareArtDone");
    } catch (error) {
      if (error && error.name === "AbortError") showSaveMessage("shareCancelled");
      else {
        console.error(error);
        showSaveMessage("shareFailed");
      }
    }
  }
  ...
  keepDrawingButton.addEventListener("click", () => {
    statusMessage.textContent = t("keepDrawingStatus");
    drawingEnabled = true;
  });
  ...
  shareArtButton.addEventListener("click", () => shareCanvas(artCanvas, `ai-mind-artwork-${Date.now()}.png`));
