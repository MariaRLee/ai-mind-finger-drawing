...
(() => {
  ...
  const translations = {
    zh: {
      ...
      subtitle: "腦心畫",
      intro: "5／10 秒分析後可繼續畫畫，並可下載原始手繪圖與心境靈感藝術。",
      controlKicker: "創作設定",
      ...
      drawAgain: "再畫一次",
      downloadArt: "下載作品",
      saveGuide: "按「下載作品」後，圖片會儲存到手機或電腦的下載位置；手機也可從相簿或檔案中自行分享。",
      ...
      continueStatus: "分析時段已完成，您可以繼續畫畫，也可以按「分析作品」。",
    ...
    en: {
      ...
      subtitle: "Mind Art",
      intro: "After a 5- or 10-second analysis period, you may keep drawing and download both the raw drawing and the mood-inspired artwork.",
      ...
      saveGuide: "Tap Download Artwork to save the image to your phone or computer. You can then share it yourself from Photos or Files.",
      ...
      continueStatus: "The analysis period is complete. You may keep drawing or tap “Analyze Artwork.”",
